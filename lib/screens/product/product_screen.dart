...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Future<void> _fetchProducts() async {
    try {
      final response =
          await http.get(Uri.parse('http://192.168.1.7:9090/produit/getall'));
  ...
  Future<void> _addToWishlist(id, productId) async {
    try {
      final url = Uri.parse('http://192.168.1.7:9090/wishlist/addwish');
  ...
  void _sortProductsByCategory(String category) async {
    try {
      final url = Uri.parse('http://192.168.1.7:9090/produit/getbycategory');
      final response = await http.post(url, body: {
        'category': category,
      });
  ...
  Future _fetchProductswish(id) async {
    try {
      final response = await http.post(
        Uri.parse('http://192.168.1.7:9090/wishlist/getwishid'),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Image.network(
                            'http://192.168.1.7:9090/img/${product.image}',
                            width: 80.0,
                            height: 80.0,
                            fit: BoxFit.cover,
                          ),
